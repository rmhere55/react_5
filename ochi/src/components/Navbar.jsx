...
const Navbar = () => {
  return (
    ...
    <motion.div
      ...
      animate={{ y: 0, opacity: 1 }}    // Animate down into view
      transition={{ duration: 0.5, ease: "easeOut" }} // Customize the animation duration and easing
        ...
        {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map(
          (item, index) => (
            <motion.a
              ...
              onHoverEnd={(e) => {}}
              key={index}
              className={`text-[1.2vw] capitalize cursor-pointer text-black font-normal ${
                index === 4 && "ml-32"
              }`}
            >
              {item}

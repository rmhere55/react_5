  ...
  return (
    ...
    <div className="w-full h-full  flex gap-[15vw] py-[5vw]  px-[4vw] bg-[#f1f1f1]">
      <div className="w-1\2 h-full flex flex-col justify-between ">
        <div className="heading text-[6.5vw] text-black ">
      ...
      {/* <div className="w-1\2">
        <h1 className=" text-[6.5vw] text-black tracking-tighter font-bold leading-none ">
          PRESENTATIONS
        </h1>
        <br />
        <div className="links flex justify-between">
          <div className="left">
        <div className="dets text-black">
              <h1>S:</h1>
              <br />
        ...
        <div className=" right pt-[20vh] text-black">
...
<div className="w-1/2">
  ...
  <div className="links flex justify-between">
    ...
    <div className="debts right pt-[20vh] text-black">
      <div className="text-black">
        <h1>E:</h1>
        <br />
        <a className="block" href="#">
